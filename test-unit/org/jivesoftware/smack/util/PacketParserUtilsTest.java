...
public class PacketParserUtilsTest {
    ...
    public void singleMessageBodyTest() throws Exception {
        ...
        Message message = PacketParserUtils.parseMessage(getPacket(control));
        ...
        message = PacketParserUtils.parseMessage(getPacket(control));
    ...
    public void invalidXMLInMessageBody() throws Exception {
        ...
        try {
            PacketParserUtils.parseMessage(getPacket(invalidControl));
            fail("Exception should be thrown");
        } catch(XMPPException e) {
            XmlPullParserException e2 = (XmlPullParserException) e.getCause();
    ...
    public void multipleMessageBodiesParsingTest() throws Exception {
        ...
        Packet message = PacketParserUtils.parseMessage(getPacket(control));
        assertXMLEqual(control, message.toXML());
    }
