...
public class StringPrep {
    ...
    static abstract public class StringPrepError extends Exception {
        protected StringPrepError(String message) { super(message); }
    };

    /** A prohibited character was detected. */
    static public class StringPrepProhibitedCharacter extends StringPrepError {
        StringPrepProhibitedCharacter() { super("String contains a prohibited character"); }
        protected StringPrepProhibitedCharacter(String s) { super(s); }
    };
    ...
    static public class StringPrepUnassignedCodepoint extends StringPrepProhibitedCharacter {
        StringPrepUnassignedCodepoint() { super("String contains an unassigned codepoint"); }
    };

    /** RTL verification has failed, according to rfc3454 section 6. */
    static public class StringPrepRTLError extends StringPrepError { StringPrepRTLError() { super("Invalid RTL string"); } };
